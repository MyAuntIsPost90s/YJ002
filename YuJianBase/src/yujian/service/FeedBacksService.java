...
public class FeedBacksService {
	...
	public List<FeedBacksAndUser> getListByPage(int page,int pageSize,int feedbacktype,int feedbackstatus){
		return feedBacksMapper.getListByPage((page-1)*pageSize, pageSize, feedbacktype, feedbackstatus);
	}
	...
	public int getAllCount(int feedbackstatus) {
		return feedBacksMapper.getAllCount(feedbackstatus);
	}
	public FeedBacksAndUser getSingle(String feedbackid) {
		return feedBacksMapper.getSingle(feedbackid);
	}
	public long getCount(int feedbacktype,int feedbackstatus) {
		return feedBacksMapper.getCount(feedbacktype, feedbackstatus);
	}
