			...
			$.post('/YuJian/Users/GetOtherUserInfo'
					...
					,function(data){
						...
						if(usertype!=UserType.VIP){
							temp='<div class="swiper-slide"><img class="blur" src="'+data.headimgurl+'"/></div>'
						}
			...
			$.post('/YuJian/UserImgs/GetUserImgs'
					...
					,function(data){
						...
						for(var i=0;i<data.length;i++){
							var url=data[i].userimgurl;
							var temp='<div class="swiper-slide"><img data-imgid="{0}" src="{1}"/></div>'
							if(usertype!=UserType.VIP){
								url=getMiniUrl(data[i].userimgurl);
								temp='<div class="swiper-slide"><img class="blur" data-imgid="{0}" src="{1}"/></div>'
							}
